        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Flag = table.Column<string>(type: "varchar(80)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_Players_PlayerAId",
                        column: x => x.PlayerAId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_Players_PlayerBId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_PlayerAId",
                table: "Events",
                column: "PlayerAId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_PlayerBId",
                table: "Events",
                column: "PlayerBId");
